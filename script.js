...
const appData = {
  ...
  routeCards: [
    { key: 'kajansi', cityA: 'Entebbe', cityB: 'Kampala', stageA: 'Entebbe Main Stage', stageB: 'Kampala Main Stage', via: 'Via Kajansi', price: 'UGX 5,000', imageA: 'assets/entebbe.jpg', imageB: 'assets/kampala.jpg', corridor: 'Entebbe \u2022 Kitooro \u2022 Abayita Ababiri \u2022 Kajjansi \u2022 Clock Tower \u2022 Kampala', coordA: [0.0618, 32.4742], coordB: [0.3136, 32.5811] },
    { key: 'busega', cityA: 'Entebbe', cityB: 'Kampala', stageA: 'Entebbe Main Stage', stageB: 'Kampala Main Stage', via: 'Via Busega', price: 'UGX 5,000', imageA: 'assets/entebbe.jpg', imageB: 'assets/kampala.jpg', corridor: 'Entebbe \u2022 Kitooro \u2022 Abayita Ababiri \u2022 Busega \u2022 Clock Tower \u2022 Kampala', coordA: [0.0618, 32.4742], coordB: [0.3136, 32.5811] },
    ...
    return `
      ...
      <div class="route-selector-cards" style="margin-top: 16px; display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 20px;">
        ${appData.routeCards.map(rc => {
          ...
          return `
            <div class="popular-place-card ${isExpanded ? 'is-expanded' : ''}" style="border-radius: 24px; overflow: hidden; background: white; border: 5px solid #ffffff; outline: 1px solid var(--border); box-shadow: 0 10px 28px rgba(0,0,0,0.1); transition: transform 0.25s var(--ease), box-shadow 0.25s var(--ease);">
